<?php ob_start() ?>
  <?php if (!RASPI_MONITOR_ENABLED) : ?>
      <div class="cbi-page-actions">
        <input type="submit" class="btn btn-outline btn-primary" value="<?php echo _("Save settings"); ?>" name="saveasciisettings" />
        <input type="submit" class="btn btn-success" value="<?php echo _("Apply settings"); $msg=_("Restarting dct"); ?>" data-toggle="modal" data-target="#hostapdModal" name="applyasciisettings" />
      </div>
  <?php endif ?>
  <!-- Modal -->
          ...
          <form method="POST" action="ascii_conf" role="form">
            ...
            <?php echo CSRFTokenFieldTag() ?>       
              <div class="cbi-section cbi-tblsection" id="page_ascii" name="page_ascii">
                <table class="table cbi-section-table" name="table_ascii" id="table_ascii">
...
<div id="popBox" style="overflow:auto">
  ...
  <div class="cbi-section">
    ...
    <div class="cbi-value">
      ...
      ?>
      <?php if ($com1_enable[0] == "1" && $com1_proto[0] == "4") { ?>
        <option value="COM1">COM1</option>
      <?php } ?>
      <?php if ($com2_enable[0] == "1" && $com2_proto[0] == "4") { ?>
        <option value="COM2">COM2</option>
      <?php } ?>
      <?php if ($com3_enable[0] == "1" && $com3_proto[0] == "4") { ?>
        <option value="COM3">COM3</option>
      <?php } ?>
      <?php if ($com4_enable[0] == "1" && $com4_proto[0] == "4") { ?>
        <option value="COM4">COM4</option>
      <?php } ?>  
      <?php if ($tcp1_enable[0] == "1" && $tcp1_proto[0] == "5") { ?>
        <option value="TCP1">TCP1</option>
      <?php } ?>
      <?php if ($tcp2_enable[0] == "1" && $tcp2_proto[0] == "5") { ?>
        <option value="TCP2">TCP2</option>
      <?php } ?>
      <?php if ($tcp3_enable[0] == "1" && $tcp3_proto[0] == "5") { ?>
        <option value="TCP3">TCP3</option>
      <?php } ?>
      <?php if ($tcp4_enable[0] == "1" && $tcp4_proto[0] == "5") { ?>
        <option value="TCP4">TCP4</option>
      <?php } ?>
      <?php if ($tcp5_enable[0] == "1" && $tcp5_proto[0] == "5") { ?>
        <option value="TCP5">TCP5</option>
      <?php } ?>

      <?php if (($com1_enable[0] == null || $com1_enable[0]  == "0"  || $com1_proto[0] != "4") &&
        ($com2_enable[0] == null || $com2_enable[0]  == "0" || $com2_proto[0] != "4") &&
        ($com3_enable[0] == null || $com3_enable[0]  == "0" || $com3_proto[0] != "4") &&
        ($com4_enable[0] == null || $com4_enable[0]  == "0" || $com4_proto[0] != "4") &&
        ($tcp1_enable[0] == null || $tcp1_enable[0]  == "0" || $tcp1_proto[0] != "5") &&
        ($tcp2_enable[0] == null || $tcp2_enable[0]  == "0" || $tcp2_proto[0] != "5") &&
        ($tcp3_enable[0] == null || $tcp3_enable[0]  == "0" || $tcp3_proto[0] != "5") &&
        ($tcp4_enable[0] == null || $tcp4_enable[0]  == "0" || $tcp4_proto[0] != "5") &&
        ($tcp5_enable[0] == null || $tcp5_enable[0]  == "0" || $tcp5_proto[0] != "5")) { 
      ?>
    ...
    <div class="cbi-value">
      <label class="cbi-value-title" for="widget.factor_name"><?php echo _("Channel Name"); ?></label>
  ...
  <div class="right">
    ...
    <button class="cbi-button cbi-button-positive important" onclick="saveDataAscii()"><?php echo _("Save"); ?></button>
  </div>
</div><!-- popBox -->