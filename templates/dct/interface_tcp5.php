  ...
  <div class="row">
    ...
    <div id="page_tcp5" name="page_tcp5">
      ...
      <div class="cbi-value">
        ...
        <input type="text" class="cbi-input-text" name="tcp_frame_interval5" id="tcp_frame_interval5" />
        <label class="cbi-value-description"><?php echo _("ms"); ?></label>
      </div>

      <div class="cbi-value">
        <label class="cbi-value-title"><?php echo _("Protocol"); ?></label>
        <select id="tcp_protocol5" name="tcp_protocol5" class="cbi-input-select" onchange="tcpProtocolChange5(this)">
      ...
      <div class="cbi-value" id="tcp_page_protocol_modbus5" name="tcp_page_protocol_modbus5">
        ...
        <input type="text" class="cbi-input-text" name="tcp_command_interval5" id="tcp_command_interval5" />
        <label class="cbi-value-description"><?php echo _("ms"); ?></label>
      </div>
      ...
      <div class="cbi-value" id="tcp_page_protocol_transparent5" name="tcp_page_protocol_transparent5">
        ...
        <input type="text" class="cbi-input-text" name="tcp_reporting_center5" id="tcp_reporting_center5" />
...
<script type="text/javascript">
  ...
  function tcpProtocolChange5(that) {
    var protocol = document.getElementById("tcp_protocol5").value;
